...
<table class="table"  width="100%" >
    ...
    <tbody>
        ...
        echo '
            ...
            <td style="text-align:center;">'.$data1["name"].'</td>
           <td style="text-align:center; z-index:-1"> <a href="edit-rece.php?id='.$data1['id'].'" style="text-decoration:none" class="badge alert alert-primary p-1 px-2">Edit</a>|<a href="delete.php?id='.$data1['id'].'" style="text-decoration:none" class="badge alert alert-danger p-1 px-2">Delete</a>  </td>
            </tr>';
        }
        ?>
    </tbody>
